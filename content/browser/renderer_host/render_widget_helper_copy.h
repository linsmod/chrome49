...
#ifndef CONTENT_BROWSER_RENDERER_HOST_RENDER_WIDGET_HELPER_COPY_H_
#define CONTENT_BROWSER_RENDERER_HOST_RENDER_WIDGET_HELPER_COPY_H_
...
class RenderWidgetHelper_copy
    : public base::RefCountedThreadSafe<RenderWidgetHelper_copy,
                                        BrowserThread::DeleteOnIOThread> {
 public:
  RenderWidgetHelper_copy();
  ...
  static RenderWidgetHelper_copy* FromProcessHostID(int render_process_host_id);
 ...
 private:
  friend class base::RefCountedThreadSafe<RenderWidgetHelper_copy>;
  friend struct BrowserThread::DeleteOnThread<BrowserThread::IO>;
  friend class base::DeleteHelper<RenderWidgetHelper_copy>;
  ...
  DISALLOW_COPY_AND_ASSIGN(RenderWidgetHelper_copy);
};
